...
class SyringeController(CommandSender):
    ...
    def emergency_stop(self) -> None:
        ...
        Terminates any ongoing movement without updating volume tracking.
        Use initialize() after emergency stop to re-synchronize position.
        
        Examples:
            >>> syringe.emergency_stop()  # Stop immediately
            >>> syringe.initialize()      # Re-home after stop
        """
