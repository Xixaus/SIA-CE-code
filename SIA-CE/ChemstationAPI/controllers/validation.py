...
class ValidationModule():
    ...
    def validate_method(self, method: str, dir_path: str = "_METHPATH$", check_vials: bool = False) -> None:
        ...
        if dir_path == "_METHPATH$":
            dir_path = Path(self.comm.send("response$ = _METHPATH$", timeout=15))
        ...
        if check_vials:
            ...
            required_vials = self.extract_vials_from_xml(method_path)  # Jen cesta k metodě
            if required_vials:
